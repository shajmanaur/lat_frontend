        ...
        <div className="flex gap-4" style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <select style={{ width: '100%', padding: '8px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-light)' }}>
              ...
              <option value="Rajesh Kumar (KV1001)">Rajesh Kumar (KV1001)</option>
            </select>
          </div>
          <div style={{ flex: 1 }}>
            ...
            <select style={{ width: '100%', padding: '8px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-light)' }}>
              ...
              <option value="LAT 2025">LAT 2025</option>
            </select>
          </div>
        </div>
      ...
      {!isFiltered ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 mt-8">
          <div className="relative mb-6">
            ...
            {/* Playful squiggly arrow icon indicating to select filters above */}
